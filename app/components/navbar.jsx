    ...
    <nav className="bg-transparent">
      <div className="flex items-center justify-center md:justify-between py-5">
        <div className="flex flex-shrink-0 items-center">
          <Link
            href="/"
            className=" text-[#fbff86] text-3xl font-bold">
            Gyan Prakash
          </Link>
        </div>

        <ul className="mt-4 md:flex h-screen max-h-0 w-full flex-col items-start text-sm hidden md:mt-0 md:h-auto md:max-h-screen md:w-auto md:flex-row md:space-x-1 md:border-0 " id="navbar-default">
          <li>
